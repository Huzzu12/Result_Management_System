...
class studentClass:
    def __init__(self,root):
        ...
        #====tiltle====
        title=Label(self.root,text="Manage Student Ditails",font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1180,height=35)

        #====studentLable column 1 ====
    ...
    #====studentLable column 2 ====
        ...
        lbl_addminssion=Label(self.root,text="Addmission",font=("goudy old style",15,"bold"),bg="white").place(x=360,y=140)
        lbl_course=Label(self.root,text="Course",font=("goudy old style",15,"bold"),bg="white").place(x=360,y=180)

    #====student text field=====
        self.course_list=[]
    #===funtion call to update the list
        self.fetch_course()
...
#====search button====
        btn_search=Button(self.root,text="Search",font=("goudy old style",15,"bold"),bg="lightgreen",fg="white",cursor="hand2",command=self.search).place(x=1070,y=60,width=120,height=28)
